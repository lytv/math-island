...
FRAMES_DIR = OUTPUT_DIR / 'frames/tens-and-ones-v3'
SILENT_VIDEO = OUTPUT_DIR / 'math-island-tens-and-ones-v3-silent.mp4'
FINAL_VIDEO = OUTPUT_DIR / 'math-island-tens-and-ones-v3.mp4'
AUDIO = OUTPUT_DIR / 'tens-and-ones-v3-narration-synced.mp3'
